...
### 1.2 Product goal
Build a mobile-first web that helps users assess whether a romantic partner is suitable for marriage by evaluating:
- relationship safety
...
- Estimated completion time: **3–5 分钟**
...
Every question set should consider whether to include:
- 我不确定 / 还没看清
- 不适用
- 不方便回答

This is critical to reduce forced inaccurate answers.
